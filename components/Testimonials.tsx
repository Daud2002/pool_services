...
const testimonials = [
  {
    ...
    content: 'Best Pool Technical Services has been maintaining our pool for over two years now. Their attention to detail and professionalism is outstanding. The water is always crystal clear, and they never miss a scheduled visit.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'We manage multiple properties and Best Pool Technical Services handles all our pool maintenance. Their transparent pricing and consistent quality make them our go-to choice. The team is always punctual and professional.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'We have been working with Best Pool Technical Services for our resort pools for three years. Their expertise in commercial pool maintenance is unmatched. They handle everything efficiently and our guests always compliment the pristine pool conditions.',
    rating: 5,
    image: '/assets/random.jpeg',
  },
  {
    ...
    content: 'From installation to ongoing maintenance, Best Pool Technical Services has exceeded all expectations. Their eco-friendly approach and use of quality products ensure our pool is safe for our children. Highly professional team!',
    rating: 5,
    image: '/assets/about_2.jpg',
  },
  {
  ...
  },
  {
    ...
    content: 'I cannot recommend Best Pool Technical Services enough! Their team is always professional, courteous, and thorough. They take pride in their work and it shows. Our pool has never looked better since we started using their services.',
    rating: 5,
    image: '/assets/service_1.jpg',
  },
  {
    ...
    content: 'As a developer, I need reliable partners. Best Pool Technical Services Dubai has been our exclusive pool contractor for multiple projects. Their quality workmanship and timely delivery make them stand out in the industry.',
    rating: 5,
    image: '/assets/random.jpeg',
  },
  {
    ...
    content: 'Excellent service from a truly dedicated team! They are responsive, knowledgeable, and always go the extra mile. Our pool maintenance has been hassle-free since switching to Best Pool Technical Services. Best decision we made!',
    rating: 5,
    image: '/assets/about_2.jpg',
  },
  {
    ...
    content: 'Five-star service all the way! Best Pool Technical Services maintains our pool to perfection. Their technicians are experts who provide valuable advice on pool care. The water quality is consistently excellent and the service is reliable.',
    rating: 5,
    image: '/assets/about_3.jpg',
  },
  {
    ...
    content: 'Professional, efficient, and trustworthy! Best Pool Technical Services has been taking care of our pool for over a year now. They arrive on schedule, complete the work quickly, and leave everything spotless. Highly satisfied with their service!',
    rating: 5,
    image: '/assets/service_1.jpg',
  },
];
