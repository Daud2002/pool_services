        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="relative h-[350px] xs:h-[400px] sm:h-[500px] md:h-[550px] lg:h-[600px] order-2 md:order-1">
            ...
            <motion.div 
              ...
              className="absolute top-0 left-0 w-[75%] sm:w-[80%] h-[80%] sm:h-[85%] md:h-[90%] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl group ring-2 ring-white/50"
            >
              <Image
          ...
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6 md:space-y-8 order-1 md:order-2">
            ...
            <motion.h3 
              ...
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 0.7, delay: 0.2, ease: "easeOut" }}
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#002D57] leading-tight"
            >
              Your Trusted Partner for <span className="text-transparent bg-clip-text bg-linear-to-r from-sky-600 to-blue-600">Pristine Pools</span>
            </motion.h3>
            <motion.p 
            ...
            <motion.div 
              ...
              className="flex flex-wrap gap-4 sm:gap-6 mt-2 sm:mt-4"
            >
