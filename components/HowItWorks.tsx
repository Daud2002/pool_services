    ...
    <section className="py-16 sm:py-20 md:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          ...
          <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#002D57] mb-3 sm:mb-4 px-4">A Simple, Seamless Process</h3>
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">Follow these four easy steps to get your pool looking pristine and beautiful</p>
        </div>
